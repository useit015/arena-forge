...
function GeometryParametersPanel(editor, object) {
  ...
  radiusRow.add(
    new UIText(strings.getKey('sidebar/geometry/capsule_geometry/radius')).setClass('Label')
  );
  ...
  heightRow.add(
    new UIText(strings.getKey('sidebar/geometry/capsule_geometry/height')).setClass('Label')
  );
  ...
  capSegmentsRow.add(
    new UIText(strings.getKey('sidebar/geometry/capsule_geometry/capseg')).setClass('Label')
  );
  ...
  radialSegmentsRow.add(
    new UIText(strings.getKey('sidebar/geometry/capsule_geometry/radialseg')).setClass('Label')
  );
  ...
  heightSegmentsRow.add(
    new UIText(strings.getKey('sidebar/geometry/capsule_geometry/heightseg')).setClass('Label')
  );
