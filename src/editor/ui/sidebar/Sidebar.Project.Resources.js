...
function SidebarProjectResources(editor) {
  ...
  function refreshGeometriesUI() {
    ...
    geometriesInfo.setValue(
      geometries.length + ' ' + strings.getKey('sidebar/project/geometries').toLowerCase()
    );
  }
  ...
  function refreshMaterialsUI() {
    ...
    materialsInfo.setValue(
      materials.length + ' ' + strings.getKey('sidebar/project/materials').toLowerCase()
    );
  }
  ...
  function refreshTexturesUI() {
    ...
    texturesInfo.setValue(
      textures.length + ' ' + strings.getKey('sidebar/project/textures').toLowerCase()
    );
  }
