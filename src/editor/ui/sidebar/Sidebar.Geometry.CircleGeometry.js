...
function GeometryParametersPanel(editor, object) {
  ...
  radiusRow.add(
    new UIText(strings.getKey('sidebar/geometry/circle_geometry/radius')).setClass('Label')
  );
  ...
  segmentsRow.add(
    new UIText(strings.getKey('sidebar/geometry/circle_geometry/segments')).setClass('Label')
  );
  ...
  thetaStartRow.add(
    new UIText(strings.getKey('sidebar/geometry/circle_geometry/thetastart')).setClass('Label')
  );
  ...
  thetaLengthRow.add(
    new UIText(strings.getKey('sidebar/geometry/circle_geometry/thetalength')).setClass('Label')
  );
