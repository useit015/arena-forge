...
function SidebarMaterial(editor) {
  ...
  const materialIOR = new SidebarMaterialNumberProperty(
    editor,
    'ior',
    strings.getKey('sidebar/material/ior'),
    [1, 2.333],
    3
  );
  ...
  const materialDispersion = new SidebarMaterialNumberProperty(
    editor,
    'dispersion',
    strings.getKey('sidebar/material/dispersion'),
    [0, 10]
  );
  ...
  materialUserDataRow.add(
    new UIText(strings.getKey('sidebar/material/userdata')).setClass('Label')
  );
  ...
  exportJson.onClick(function () {
    ...
    const material = Array.isArray(object.material)
      ? object.material[currentMaterialSlot]
      : object.material;
    ...
    if (material) {
      ...
      if (material.type !== materialClass.getValue()) {
        ...
        editor.execute(
          ...
          strings.getKey('command/SetMaterial') + ': ' + materialClass.getValue()
        );
